<%@ Page Language="VB" AutoEventWireup="false" CodeFile="bank_details.aspx.vb" Inherits="bank_details" %>
...
<body  >
   ...
   <asp:Menu ID="Menu1" runat="server" ForeColor="#9FE870" Orientation="Horizontal" 
        ...
        <Items>
                <asp:MenuItem Text="back" Value="back" NavigateUrl="~/signup.aspx"></asp:MenuItem>
        </Items>
    ...
    <asp:Panel ID="Panel1" runat="server" class="panel"
        ...
        <header Font-Names="Lucida Console" >Bank Details</header>
        ...
        <asp:TextBox ID="TextBox2" runat="server" class="txtbox" Font-Size="15pt" required onkeydown="return /[A-Za-z .]/i.test(event.key)"
        ...
        <asp:TextBox ID="TextBox10" runat="server" class="txtbox" Font-Size="15pt" 
            ...
            style="z-index: 1; left: 40px; top: 354px; position: absolute; height: 36px; width: 287px;" 
        ...
        <asp:TextBox ID="TextBox11" runat="server" class="txtbox" Font-Size="15pt" 
            required
             onkeypress="return /[0-9]/i.test(event.key)"
            
            style="z-index: 1; left: 780px; top: 352px; position: absolute; height: 36px; width: 287px;" 
            MaxLength="13"></asp:TextBox>
        <asp:TextBox ID="TextBox12" runat="server" class="txtbox" Font-Size="15pt" onkeydown="return /[A-Za-z .]/i.test(event.key)"
            required
        ...
        <asp:DropDownList ID="gender" runat="server" class="frame" required
        ...
        <asp:TextBox ID="TextBox6" runat="server"  class="txtbox" 
            Font-Size="15pt" required
             onkeypress="return /[0-9]/i.test(event.key)"
            style="z-index: 1; left: 34px; top: 252px; position: absolute; height: 36px; width: 287px; right: 770px;" 
            MaxLength="10"></asp:TextBox>
        <hr style="z-index: 1; left: 3px; top: 301px; position: absolute; height: 0px; width: 1109px" />
        <asp:DropDownList ID="acctype" runat="server" class="frame" required="please enter gender"
            Font-Names="Lucida Console" Font-Size="13pt" 
        ...
        <asp:Label ID="Label16" runat="server" Font-Names="Lucida Console" 
            ...
            style="z-index: 1; left: 409px; top: 505px; position: absolute; height: 35px; width: 148px; right: 558px;" 
            Text="submit" />
        <asp:Button ID="Button2" runat="server" class="submitf" Font-Bold="True" type="reset" 
            Font-Names="Lucida Console" Font-Size="11pt" 
            style="z-index: 1; left: 600px; top: 504px; position: absolute; height: 35px; width: 148px;" 
            Text="reset" />
        <asp:Label ID="Label17" runat="server" Font-Bold="False" 
            Font-Names="Lucida Console" Font-Size="13pt" 
            style="z-index: 1; left: 36px; top: 486px; position: absolute" 
            Text="Login name"></asp:Label>
        <asp:TextBox ID="TextBox14" runat="server" class="txtbox" Font-Size="15pt" 
            required
            
            
            style="z-index: 1; left: 34px; top: 509px; position: absolute; height: 36px; width: 287px;"></asp:TextBox>
        <asp:Image ID="Image2" runat="server" ImageUrl="~/photos/catwriting.gif" 
            style="z-index: 1; left: 819px; top: 396px; position: absolute; height: 161px; width: 160px" />
    </asp:Panel>
