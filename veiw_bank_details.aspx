<%@ Page Language="VB" AutoEventWireup="false" CodeFile="veiw_bank_details.aspx.vb" Inherits="veiw_bank_details" %>
...
<body  >
    ...
    <asp:Image ID="Image1" runat="server" ImageUrl="~/photos/cash_text.png" 
        ...
        style="z-index: 1; left: 104px; top: 16px; position: absolute; height: 95px; width: 168px" />
   ...
   <asp:Menu ID="Menu1" runat="server" ForeColor="#9FE870" Orientation="Horizontal" 
    ...
    <asp:Panel ID="Panel1" runat="server" class="panel"
        ...
        <header Font-Names="Lucida Console" >Your Bank Details</header>
        ...
        <asp:TextBox ID="TextBox1" runat="server" class="txtbox" required ReadOnly
        ...
        <asp:TextBox ID="TextBox2" runat="server" class="txtbox" Font-Size="15pt" required ReadOnly
        ...
        <asp:TextBox ID="TextBox3"  runat="server" class="txtbox" Font-Size="15pt" required ReadOnly
        ...
        <asp:TextBox ID="TextBox4" runat="server" class="txtbox" Font-Size="15pt" ReadOnly
            required
            
            style="z-index: 1; left: 34px; top: 172px; position: absolute; height: 36px; width: 287px;"></asp:TextBox>
        <asp:TextBox ID="TextBox5" runat="server" class="txtbox" Font-Size="15pt" ReadOnly
            required 
        ...
        <asp:TextBox ID="TextBox7" runat="server" class="txtbox" Font-Size="15pt" ReadOnly
            required
        ...
        <asp:TextBox ID="TextBox8" type="email" runat="server" class="txtbox" Font-Size="15pt" ReadOnly
            required
        ...
        <asp:TextBox ID="TextBox10" runat="server" class="txtbox" Font-Size="15pt" ReadOnly
            required
        ...
        <asp:TextBox ID="TextBox11" runat="server" class="txtbox" Font-Size="15pt" ReadOnly
            required
            
            style="z-index: 1; left: 780px; top: 352px; position: absolute; height: 36px; width: 287px;"></asp:TextBox>
        <asp:TextBox ID="TextBox12" runat="server" class="txtbox" Font-Size="15pt" ReadOnly
            required
            
            style="z-index: 1; left: 34px; top: 427px; position: absolute; height: 36px; width: 287px;"></asp:TextBox>
        <asp:TextBox ID="TextBox13" runat="server" class="txtbox" Font-Size="15pt" ReadOnly
        ...
        <asp:DropDownList ID="gender" runat="server" class="frame" 
            Font-Names="Lucida Console" Font-Size="13pt" ReadOnly
        ...
        <asp:TextBox ID="TextBox6" runat="server" type="number" class="txtbox" ReadOnly
            Font-Size="15pt" required
        ...
        <asp:DropDownList ID="acctype" runat="server" class="frame" ReadOnly
        ...
        <asp:Label ID="Label16" runat="server" Font-Names="Lucida Console" 
            ...
            style="z-index: 1; left: 410px; top: 511px; position: absolute; height: 35px; width: 148px; right: 557px;" 
            Text="EDIT" />
        
        <asp:Label ID="Label18" runat="server" Font-Bold="False" 
            Font-Names="Lucida Console" Font-Size="13pt" 
            style="z-index: 1; left: 42px; top: 483px; position: absolute" 
            Text="Login name"></asp:Label>
        <asp:TextBox ID="TextBox14" runat="server" class="txtbox" Font-Size="15pt" readonly
            required="" 
            style="z-index: 1; left: 35px; top: 503px; position: absolute; height: 36px; width: 287px;"></asp:TextBox>
        <asp:Image ID="Image2" runat="server" ImageUrl="~/photos/cat_coffee.gif" 
            style="z-index: 1; left: 857px; top: 407px; position: absolute; height: 142px; width: 147px" />
            <asp:Button ID="Button2" runat="server" class="submitf" Font-Bold="True" type="reset" 
            Font-Names="Lucida Console" Font-Size="11pt" 
            style="z-index: 1; left: 583px; top: 510px; position: absolute; height: 35px; width: 148px;" 
            Text="BACK" />
    </asp:Panel>
    ...
    <asp:Label ID="Label17" runat="server" 
        style="z-index: 1; left: 11px; top: 212px; position: absolute" Text="Label" 
